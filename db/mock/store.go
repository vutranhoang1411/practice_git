...
// Source: github.com/vutranhoang1411/SimpleBank/db/sqlc (interfaces: Store)
...
func (m *MockStore) WithDrawTx(arg0 context.Context, arg1 db.WithDrawMoneyArg) (db.WithDrawMoneyResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WithDrawTx", arg0, arg1)
	ret0, _ := ret[0].(db.WithDrawMoneyResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
